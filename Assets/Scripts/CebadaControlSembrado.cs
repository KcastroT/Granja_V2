...
public class CebadaControlSembrado : MonoBehaviour
{
    ...
    public GameObject draggedCebada; // Asumo que este es el GameObject que tiene el componente DragCebada.
    ...
    void Update()
    {
        ...
        if (tileComponent.IsTouched && DragCebada.isDragging && !sembrado)
        {
            etapa = 1;
            //en esta condicion lo quiero decrementar al contador maiz
            GameObject.FindAnyObjectByType<Contadores>().DecrementarContadorCebada();
        }
