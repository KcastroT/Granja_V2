...
// DragCebada gestiona la funcionalidad de arrastrar y soltar para un objeto de cebada en la interfaz de usuario.
public class DragCebada : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IDropHandler
{
