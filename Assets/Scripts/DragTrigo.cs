...
// DragTrigo gestiona la funcionalidad de arrastrar y soltar para un objeto de trigo en la interfaz de usuario.
public class DragTrigo : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IDropHandler
{
